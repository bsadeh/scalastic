...
class GeoDistanceFacetTests extends IndexerBasedTest {
  ...
  test("simpleGeoFacetTests") {
    ...
    facet.getEntries.get(0).getTo should be(2.0 +- 0.000001)
    facet.getEntries.get(0).getCount should equal (4)
    facet.getEntries.get(0).getTotal should not be (0.0 +- 0.00001)
    facet.getEntries.get(1).getFrom should be(0.0 +- 0.000001)
    facet.getEntries.get(1).getTo should be(1.0 +- 0.000001)
    facet.getEntries.get(1).getCount should equal (2)
    facet.getEntries.get(1).getTotal should not be (0.0 +- 0.00001)
    facet.getEntries.get(2).getFrom should be(0.5 +- 0.000001)
    facet.getEntries.get(2).getTo should be(2.5 +- 0.000001)
    facet.getEntries.get(2).getCount should equal (3)
    facet.getEntries.get(2).getTotal should not be (0.0 +- 0.00001)
    facet.getEntries.get(3).getFrom should be(1.0 +- 0.000001)
    facet.getEntries.get(3).getCount should equal (5)
    facet.getEntries.get(3).getTotal should not be (0.0 +- 0.00001)
    ...
    facet.getEntries.get(0).getTo should be(2.0 +- 0.000001)
    facet.getEntries.get(0).getCount should equal (4)
    facet.getEntries.get(0).getTotal should be(13.0 +- 0.00001)
    facet.getEntries.get(1).getFrom should be(0.0 +- 0.000001)
    facet.getEntries.get(1).getTo should be(1.0 +- 0.000001)
    facet.getEntries.get(1).getCount should equal (2)
    facet.getEntries.get(1).getTotal should be(4.0 +- 0.00001)
    facet.getEntries.get(2).getFrom should be(0.5 +- 0.000001)
    facet.getEntries.get(2).getTo should be(2.5 +- 0.000001)
    facet.getEntries.get(2).getCount should equal (3)
    facet.getEntries.get(2).getTotal should be(15.0 +- 0.00001)
    facet.getEntries.get(3).getFrom should be(1.0 +- 0.000001)
    facet.getEntries.get(3).getCount should equal (5)
    facet.getEntries.get(3).getTotal should be(24.0 +- 0.00001)
    response = indexer.search_prepare().setQuery(matchAllQuery).addFacet(geoDistanceFacet("geo1").field("location").point(40.7143528,
      -74.0059731)
      .unit(DistanceUnit.KILOMETERS)
  ...
  test("multiLocationGeoDistanceTest") {
    ...
    facet.getEntries.get(0).getFrom should be(0.0 +- 0.000001)
    facet.getEntries.get(0).getTo should be(2.0 +- 0.000001)
    facet.getEntries.get(0).getCount should equal (2)
    facet.getEntries.get(1).getFrom should be(2.0 +- 0.000001)
    facet.getEntries.get(1).getTo should be(10.0 +- 0.000001)
