...
@org.junit.runner.RunWith(classOf[org.scalatest.junit.JUnitRunner]) class CustomScoreSearchTests extends IndexerBasedTest {
  ...
  test("testCustomScriptBoost") {
    ...
    response.getHits.getAt(1).id should be === ("1")
    //logger.info("running -doc['num1'].value")
  ...
  test("testCustomFiltersScore") {
    ...
    response.getHits.totalHits should be === (4)
    response.getHits.getAt(0).id should be === ("2")
    response.getHits.getAt(0).score() should be === (3.0)
    //logger.info("--> Hit[0] {} Explanation {}", response.getHits.getAt(0).id(), response.getHits.getAt(0).explanation())
    Set("4") should contain(response.getHits.getAt(1).id)
    response.getHits.getAt(1).score() should be === (2.0)
    Set("1", "3") should contain(response.getHits.getAt(2).id)
    response.getHits.getAt(2).score() should be === (1.0)
    Set("1", "3") should contain(response.getHits.getAt(3).id)
    response.getHits.getAt(3).score() should be === (1.0)
    ...
    response.getHits.totalHits should be === (4)
    response.getHits.getAt(0).id should be === ("1")
    response.getHits.getAt(0).score() should be === (8.0)
    //logger.info("--> Hit[0] {} Explanation {}", response.getHits.getAt(0).id(), response.getHits.getAt(0).explanation())
    ...
    response.getHits.totalHits should be === (4)
    response.getHits.getAt(0).id should be === ("1")
    response.getHits.getAt(0).score() should be === (5.0)
    //logger.info("--> Hit[0] {} Explanation {}", response.getHits.getAt(0).id(), response.getHits.getAt(0).explanation())
    ...
    //logger.info("--> Hit[0] {} Explanation {}", response.getHits.getAt(0).id(), response.getHits.getAt(0).explanation())
    response.getHits.getAt(1).id should be === ("1")
    response.getHits.getAt(1).score() should be === (4.0)
    //logger.info("--> Hit[1] {} Explanation {}", response.getHits.getAt(1).id(), response.getHits.getAt(1).explanation())
    ...
    //logger.info("--> Hit[0] {} Explanation {}", response.getHits.getAt(0).id(), response.getHits.getAt(0).explanation())
    response.getHits.getAt(1).id should be === ("1")
    response.getHits.getAt(1).score() should be === (3.0)
    response.getHits.getAt(2).id should be === ("4")
    response.getHits.getAt(2).score() should be === (2.0)
    response.getHits.getAt(3).id should be === ("2")
    response.getHits.getAt(3).score() should be === (1.0)
    ...
    response.getHits.totalHits should be === (4)
    response.getHits.getAt(0).id should be === ("1")
    response.getHits.getAt(0).score() should be === (15.0)
    //logger.info("--> Hit[0] {} Explanation {}", response.getHits.getAt(0).id(), response.getHits.getAt(0).explanation())
    response.getHits.getAt(1).id should be === ("3")
    response.getHits.getAt(1).score() should be === (5.0)
    response.getHits.getAt(2).id should be === ("4")
    response.getHits.getAt(2).score() should be === (2.0)
    response.getHits.getAt(3).id should be === ("2")
    response.getHits.getAt(3).score() should be === (1.0)
