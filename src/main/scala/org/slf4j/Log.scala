...
object Log {
  ...
  def debug[T](caller: T, format: String, arguments: Any*) = logger(caller).debug(format, arguments.toArray)
  ...
  def debug[T](caller: T, marker: Marker, format: String, arguments: Any*) = logger(caller).debug(marker, format, arguments.toArray)
  ...
  def error[T](caller: T, format: String, arguments: Any*) = logger(caller).error(format, arguments.toArray)
  ...
  def error[T](caller: T, marker: Marker, format: String, arguments: Any*) = logger(caller).error(marker, format, arguments.toArray)
  ...
  def info[T](caller: T, format: String, arguments: Any*) = logger(caller).info(format, arguments.toArray)
  ...
  def info[T](caller: T, marker: Marker, format: String, arguments: Any*) = logger(caller).info(marker, format, arguments.toArray)
  ...
  def trace[T](caller: T, format: String, arguments: Any*) = logger(caller).trace(format, arguments.toArray)
  ...
  def trace[T](caller: T, marker: Marker, format: String, arguments: Any*) = logger(caller).trace(marker, format, arguments.toArray)
  ...
  def warn[T](caller: T, format: String, arguments: Any*) = logger(caller).warn(format, arguments.toArray)
  ...
  def warn[T](caller: T, marker: Marker, format: String, arguments: Any*) = logger(caller).warn(marker, format, arguments.toArray)
