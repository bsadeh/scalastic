...
trait Logging {
  ...
  def trace(format: String, arguments: Any*) = logger.trace(format, arguments.map(_.asInstanceOf[Object]).toArray)
  def trace(message: String, exception: Throwable) = logger.trace(message, exception)
  def isTraceEnabled = logger.isTraceEnabled

  def debug(message: String) = logger.debug(message)
  def debug(format: String, arguments: Any*) = logger.debug(format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def debug(marker: Marker, format: String, arguments: Any*) = logger.debug(marker, format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def info(format: String, arguments: Any*) = logger.info(format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def info(marker: Marker, format: String, arguments: Any*) = logger.info(marker, format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def warn(format: String, arguments: Any*) = logger.warn(format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def warn(marker: Marker, format: String, arguments: Any*) = logger.warn(marker, format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def error(format: String, arguments: Any*) = logger.error(format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def error(marker: Marker, format: String, arguments: Any*) = logger.error(marker, format, arguments.map(_.asInstanceOf[Object]).toArray)
...
object Log {
  ...
  def trace[A](caller: A, format: String, arguments: Any*) = logger(caller).trace(format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def trace[A](caller: A, marker: Marker, format: String, arguments: Any*) = logger(caller).trace(marker, format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def debug[A](caller: A, format: String, arguments: Any*) = logger(caller).debug(format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def debug[A](caller: A, marker: Marker, format: String, arguments: Any*) = logger(caller).debug(marker, format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def info[A](caller: A, format: String, arguments: Any*) = logger(caller).info(format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def info[A](caller: A, marker: Marker, format: String, arguments: Any*) = logger(caller).info(marker, format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def warn[A](caller: A, format: String, arguments: Any*) = logger(caller).warn(format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def warn[A](caller: A, marker: Marker, format: String, arguments: Any*) = logger(caller).warn(marker, format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def error[A](caller: A, format: String, arguments: Any*) = logger(caller).error(format, arguments.map(_.asInstanceOf[Object]).toArray)
  ...
  def error[A](caller: A, marker: Marker, format: String, arguments: Any*) = logger(caller).error(marker, format, arguments.map(_.asInstanceOf[Object]).toArray)
